(function () {
  ...
  (function () {
    ...
    btn.style.cssText = 'background:none;border:1.5px solid rgba(245,240,232,0.8);border-radius:3px;padding:0.25rem 0.65rem;font-size:0.75rem;letter-spacing:0.12em;color:#ffffff;font-family:var(--font-sans);cursor:pointer;line-height:1.4;font-weight:600';
    ...
    langs.forEach(function (l) {
      ...
      item.style.cssText = 'display:block;padding:0.5rem 0.9rem;font-size:0.78rem;letter-spacing:0.07em;text-decoration:none;font-family:var(--font-sans);color:#ffffff;background:' + (isCurrent ? 'rgba(245,240,232,0.12)' : 'transparent') + ';font-weight:' + (isCurrent ? '600' : '400');
      if (!isCurrent) {
